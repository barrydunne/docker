...
namespace Weather.ExternalService.Tests.OpenMeteo
{
    internal class OpenMeteoTestsContext
    {
        ...
        private readonly MockLogger<Weather.ExternalService.OpenMeteo> _mockLogger;
        ...
        internal Weather.ExternalService.OpenMeteo Sut { get; }
