...
namespace Weather.Infrastructure.ExternalApi.OpenMeteo;

/// <summary>
/// Uses OpenMeteo weather API.
/// </summary>
public class OpenMeteoApi : IExternalApi
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OpenMeteoApi"/> class.
    /// </summary>
