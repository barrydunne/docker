...
namespace Imaging.Logic.Tests.CommandHandlers.SaveImageCommandHandler
{
    internal class SaveImageCommandHandlerTestsContext
    {
        ...
        private readonly MockLogger<Imaging.Logic.CommandHandlers.SaveImageCommandHandler> _mockLogger;
        ...
        internal Imaging.Logic.CommandHandlers.SaveImageCommandHandler Sut { get; }
        ...
        public SaveImageCommandHandlerTestsContext()
        {
            ...
            _mockCloudFiles.Setup(_ => _.UploadFileAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<Stream>(), It.IsAny<CancellationToken>()))
                ...
                .ReturnsAsync(() => _withUploadFailure ? false : true);
        ...
        private Task<Result<string?>> GetImageUrl(GetImageUrlQuery query) => Task.Run(() =>
        {
            ...
            return _exceptionCoordinates.Contains(coordinates)
                ...
                : _invalidCoordinates.Contains(coordinates)
                    ? Result.Failure<string?>(GetError(query))
                    : Result.Success<string?>(_imageUrls[coordinates]);
        });
        ...
        internal SaveImageCommandHandlerTestsContext WithDownloadFailure(SaveImageCommand command)
        {
            _withDownloadFailure = true;
            return this;
        }

        internal SaveImageCommandHandlerTestsContext WithUploadFailure(SaveImageCommand command)
        {
        ...
        internal SaveImageCommandHandlerTestsContext AssertMetricsGuardTimeRecorded()
        {
