...
namespace Imaging.Api.BackgroundServices
{
    ...
    internal class LocationsReadyEventProcessor : QueueToCommandProcessor<LocationsReadyEvent, SaveImageCommand, Result>
    {
        ...
        /// <inheritdoc/>
        protected override SaveImageCommand CreateCommand(LocationsReadyEvent message) => new(message.JobId, message.DestinationAddress, message.DestinationCoordinates);
    }
}
