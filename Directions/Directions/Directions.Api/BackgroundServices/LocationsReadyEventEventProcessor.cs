...
namespace Directions.Api.BackgroundServices
{
    ...
    internal class LocationsReadyEventProcessor : QueueToCommandProcessor<LocationsReadyEvent, GenerateDirectionsCommand, Result>
    {
        ...
        /// <inheritdoc/>
        protected override GenerateDirectionsCommand CreateCommand(LocationsReadyEvent message) => new(message.JobId, message.StartingCoordinates, message.DestinationCoordinates);
    }
}
