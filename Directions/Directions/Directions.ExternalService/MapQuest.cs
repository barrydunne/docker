using Directions.ExternalService.MapQuestModels;
...
namespace Directions.ExternalService
{
    ...
    /// </summary>
    public class MapQuest : IExternalService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MapQuest"/> class.
        /// </summary>
        ...
        public MapQuest(ICloudSecrets secrets, IRestSharpClientFactory restSharpFactory, ILogger<MapQuest> logger)
        {
            _secrets = secrets;
        ...
        public async Task<Microservices.Shared.Events.Directions> GetDirectionsAsync(Coordinates startingCoordinates, Coordinates destinationCoordinates, Guid correlationId, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                var response = await client.ExecutePostAsync<DirectionsResponse>(request, cancellationToken);
