...
internal class NotifyJobStatusUpdateCommandHandlerMetrics : INotifyJobStatusUpdateCommandHandlerMetrics
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NotifyJobStatusUpdateCommandHandlerMetrics"/> class.
    /// </summary>
    /// <param name="meterFactory">The factory to supply the <see cref="Meter"/>.</param>
    public NotifyJobStatusUpdateCommandHandlerMetrics(IMeterFactory meterFactory)
    {
        var meter = meterFactory.CreateAssemblyMeter();
        var subjectName = nameof(NotifyJobStatusUpdateCommand).ToLower();
