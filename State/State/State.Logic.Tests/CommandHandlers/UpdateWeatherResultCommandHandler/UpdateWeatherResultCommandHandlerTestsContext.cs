...
namespace State.Logic.Tests.CommandHandlers.UpdateWeatherResultCommandHandler
{
    internal class UpdateWeatherResultCommandHandlerTestsContext
    {
        ...
        private readonly MockLogger<State.Logic.CommandHandlers.UpdateWeatherResultCommandHandler> _mockLogger;
        ...
        internal State.Logic.CommandHandlers.UpdateWeatherResultCommandHandler Sut { get; }
        ...
        internal UpdateWeatherResultCommandHandlerTestsContext AssertMetricsGuardTimeRecorded()
        {
