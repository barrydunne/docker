...
namespace State.Logic.Tests.CommandHandlers.UpdateGeocodingResultCommandHandler
{
    internal class UpdateGeocodingResultCommandHandlerTestsContext
    {
        ...
        private readonly MockLogger<State.Logic.CommandHandlers.UpdateGeocodingResultCommandHandler> _mockLogger;
        ...
        internal State.Logic.CommandHandlers.UpdateGeocodingResultCommandHandler Sut { get; }
        ...
        internal UpdateGeocodingResultCommandHandlerTestsContext AssertMetricsGuardTimeRecorded()
        {
