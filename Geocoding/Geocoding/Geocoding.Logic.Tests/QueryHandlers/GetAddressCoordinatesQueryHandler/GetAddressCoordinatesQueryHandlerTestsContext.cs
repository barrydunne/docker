...
namespace Geocoding.Logic.Tests.QueryHandlers.GetAddressCoordinatesQueryHandler
{
    internal class GetAddressCoordinatesQueryHandlerTestsContext
    {
        ...
        private readonly MockLogger<Geocoding.Logic.QueryHandlers.GetAddressCoordinatesQueryHandler> _mockLogger;

        private Coordinates? _coordinates;
        private string? _withExceptionMessage;

        internal Geocoding.Logic.QueryHandlers.GetAddressCoordinatesQueryHandler Sut { get; }
