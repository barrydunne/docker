...
namespace SecretsManager.Logic.Tests.CommandHandlers.SetSecretValueCommandHandler
{
    internal class SetSecretValueCommandHandlerTestsContext
    {
        ...
        private readonly MockLogger<SecretsManager.Logic.CommandHandlers.SetSecretValueCommandHandler> _mockLogger;

        internal Dictionary<string, Dictionary<string, string>> Vaults { get; }

        internal SecretsManager.Logic.CommandHandlers.SetSecretValueCommandHandler Sut { get; }
