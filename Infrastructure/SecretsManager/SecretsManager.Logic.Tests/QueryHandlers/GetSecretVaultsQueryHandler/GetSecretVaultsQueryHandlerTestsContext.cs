...
namespace SecretsManager.Logic.Tests.QueryHandlers.GetSecretValueQueryHandler
{
    internal class GetSecretVaultsQueryHandlerTestsContext
    {
        ...
        private readonly MockLogger<SecretsManager.Logic.QueryHandlers.GetSecretVaultsQueryHandler> _mockLogger;

        internal Dictionary<string, Dictionary<string, string>> Vaults { get; }

        internal SecretsManager.Logic.QueryHandlers.GetSecretVaultsQueryHandler Sut { get; }
