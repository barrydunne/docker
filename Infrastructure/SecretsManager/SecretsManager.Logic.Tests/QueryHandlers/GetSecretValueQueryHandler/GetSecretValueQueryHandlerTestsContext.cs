...
namespace SecretsManager.Logic.Tests.QueryHandlers.GetSecretValueQueryHandler
{
    internal class GetSecretValueQueryHandlerTestsContext
    {
        ...
        private readonly MockLogger<SecretsManager.Logic.QueryHandlers.GetSecretValueQueryHandler> _mockLogger;

        internal Dictionary<string, Dictionary<string, string>> Vaults { get; }

        internal SecretsManager.Logic.QueryHandlers.GetSecretValueQueryHandler Sut { get; }
