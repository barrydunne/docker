...
namespace Email.Logic.Tests.CommandHandlers.SendEmailCommandHandler
{
    internal class SendEmailCommandHandlerTestsContext
    {
        ...
        private readonly MockLogger<Email.Logic.CommandHandlers.SendEmailCommandHandler> _mockLogger;

        internal Email.Logic.CommandHandlers.SendEmailCommandHandler Sut { get; }
        ...
        internal SendEmailCommandHandlerTestsContext AssertMetricsGuardTimeRecorded()
        {
